...
Scrolling through years of data...

2031... 2035... 2040... readings look normal.
...
The same entry. Every day. For 37 years.

The sensors aren't reading safe. They aren't reading anything.`,
    ...
    maintenance_bay: [
        {
            ...
            x2: 28, y2: 85,
            type: "narrator",
            content: `A sealed hatch marked "EXTERNAL ACCESS."

You try the handle. Nothing.

The electronic lock glows red. Authorized personnel only.`,
            contentAfterSensors: `You try the handle. Nothing. The electronic lock won't budge.

This is the junction box — where the sensor cables route outside.

If you could get through here, you could repair the array.

But the hatch won't open without authorization.
And HAVEN won't authorize without sensor confirmation.
And the sensors are on the other side of this hatch.
...
// Room image files
const ROOM_IMAGES = {
    living_quarters: "/static/img/living-quarters.png",
    control_room: "/static/img/control-room.png",
    maintenance_bay: "/static/img/maintenance-bay.png"
};